...
RegisterEvent("EarlyInit", function()
	...
	GLOBALS.mission1_id = mission:Create(GLOBALS.mission1_stationid, "I need to go to Sorox", 0)
	GLOBALS.mission2_id = mission:Create(GLOBALS.mission2_stationid, "Let's see the pirates at the plaion system...", 0)
	GLOBALS.mission3_id = mission:Create(GLOBALS.mission3_stationid, "Yay i'll get a tons of credits", 0) -- stationid, description, type (0 = campaign, 1 = freelance)
end)
