...
| `mods\_examples/` |  Working example mods to learn from |
...
Full documentation is in progress. In the meantime the best reference is the examples mods in the \[`mods\_examples/`](https://github.com/1337Skid/KaamoClubModApi/tree/main/mods\_examples) folder. They cover the basics of events,hooking and are kept up to date with the latest api changes.
